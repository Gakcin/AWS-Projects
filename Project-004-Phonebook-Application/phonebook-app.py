...
app.config['MYSQL_DATABASE_DB'] = 'Please_Enter_Your_DB_'
...
# Write a function named `init_todo_db` create phonebook table within yours_phonebook db, if it doesn't exist

def init_phonebook_db():
    phonebook_table = """
    CREATE TABLE IF NOT EXISTS yours_phonebook.phonebook(
